      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-emerald-600 via-green-600 to-teal-700 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white px-8">
          ...
          <p className="text-emerald-100 text-lg leading-relaxed max-w-md">
            Join our community and discover your perfect home with our curated property listings
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <div className="w-full max-w-md">
          ...
          <div className="text-center mb-12">
            ...
            <h2 className="text-4xl font-bold text-slate-800 mb-2">Join as User</h2>
            <p className="text-slate-600">Find your dream home in seconds</p>
          </div>
